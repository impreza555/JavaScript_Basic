...
function showCategory(type) {
    let prodType = products[type];
    let div_products = null;
    prodType.forEach(function (product) {
        div_products += getProductMarkup(product);
    });
    divProd.insertAdjacentHTML("afterbegin", div_products);
}
